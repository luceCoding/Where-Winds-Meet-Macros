...
4. Type the following commands, replace the path with the correct folder path.
    ```
    python "path\to\scripts\custom_macro\start_custom_macro.py"
    ```
5. Use Ctrl + C in the command prompt or the dedicated key in your config.yaml to stop the program.